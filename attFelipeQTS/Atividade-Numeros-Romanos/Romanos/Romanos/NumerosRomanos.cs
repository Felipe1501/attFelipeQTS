...
namespace Romanos { // CORRIGIDO <3
    ...
    static void Main(string[] args) {
      try {
        ...
        if (numero > 0 && numero <= 3999) { //erro no sinal, errado: > ,  corrigido: <=
    ...
    public static bool ConverterParaRomano(int n) {
      do {
        ...
        if (n < 4000 && n > 999) {
          ...
          n -= 1000 * (n / 1000);// errado: \ corrigido: /
          //retirado return que estavam a mais
        ...
        // De 10 a 99
        else if (n < 100 && n > 9) { // errado: apenas & corrigido : &&
          switch (n / 10) { 
            case 1: rom += "X"; break;
            case 2: rom += "XX"; break;
